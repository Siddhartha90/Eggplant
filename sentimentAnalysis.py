...
# """
	...
	user_json_msg = f"You are answering questions on the following reviews```{reviews}``` How many reviews are there? Reply with a JSON array with no pretext or posttext"
